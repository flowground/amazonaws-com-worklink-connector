# ![LOGO](logo.png) Amazon WorkLink MSP Connector

## Description

A generated MSP connector for the Amazon WorkLink API (version 2018-09-25).
...
flowground :- Telekom iPaaS / amazonaws-com-worklink-connector<br/>
