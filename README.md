# ![LOGO](logo.png) Amazon WorkLink **flow**ground Connector

## Description

A generated **flow**ground connector for the Amazon WorkLink API (version 2018-09-25).

Generated from: https://api.apis.guru/v2/specs/amazonaws.com/worklink/2018-09-25/swagger.json<br/>
...
**flow**ground :- Telekom iPaaS / amazonaws-com-worklink-connector<br/>
